...
\begin{theorem}[\textenglish{Stokes}]
תהי
$M^n$
...
\begin{theorem}[משפט המעלה] \label{map-degree-2}
תהיינה
$X,Y$
יריעות סגורות ממימד
$k$
...
$x_0 \in \Uu$
נקרא
\stress{אפס בלתי־מנוון \textenglish{(non-degenerate zero)} של
$v$}
אם
\begin{align*}
v\prs{x_0} &= 0 \\
